...
function formularioCliente() {
    ...
    document.getElementById("formulario-registro").innerHTML = "\n"+
        ...
        "        <input type='text' class='form-control' id='apellidoP' data-validetta='letters,required' data-vd-message-required='Debes llenar el campo de Apellido Paterno'>\n" +
        "      </div>\n" +
        "      <div class='mb-3 input-field'>\n" +
        "        <label for='apellidoM'>Apellido materno*</label>\n" +
        "        <input type='text' class='form-control' id='apellidoM' data-validetta='letters,required' data-vd-message-required='Debes llenar el campo de Apellido Materno'>\n" +
        "      </div>\n" +
        "    </div>\n" +
        "    <div class='form-row'>\n" +
        "      <div class='mb-3 input-field'>\n" +
...
function formularioProveedor(){
    document.getElementById("formulario-registro").innerHTML = "\n" +
        ...
        "        <input type='text' id='telefono' class='form-control' data-validetta='number,required,minLength[6],maxLength[16]' data-vd-message-required='Debes llenar el campo de Telefono'>\n" +
        "      </div>\n" +
        "      <div class='mb-3 input-field'>\n" +
        "        <label for='contrasena'>Contraseña*</label>\n" +
        "        <input type='password' id='contrasena' name='contrasena' class='form-control' data-validetta='password,required' data-vd-message-required='Debes llenar el campo de Contraseña'>\n" +
